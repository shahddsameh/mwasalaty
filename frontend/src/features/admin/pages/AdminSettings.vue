    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
      ...
      <InfoCard
        ...
        :items="[
          ...
          [
            'Routes',
            loading ? '...' : String(stats?.totals.transitRoutes ?? 0),
          ],
      ...
      <InfoCard
        ...
        :items="[
          [
            'Route Searches',
            loading ? '...' : String(stats?.totals.routeSearches ?? 0),
          ],
      ...
      <InfoCard
        ...
        :items="[
          ...
          [
            'Support Tickets',
            loading ? '...' : String(stats?.totals.supportTickets ?? 0),
          ],
        ]"
      />
      <Card>
        <div class="p-5">
          ...
          <p class="text-sm text-[#6B7280]">
            Settings and system controls will appear here.
          </p>
        </div>
      </Card>
    </div>
              ...
              h(
                ...
                (props.items as string[][]).map(([label, value]) =>
                  h(
                    ...
                    [
                      h("span", { class: "text-[#9CA3AF]" }, label),
                      h(
                        "span",
