<template>
  <AuthForm title="Welcome Back" subtitle="Sign in to your Mwasalaty account">
    ...
    <AppButton size="lg" class="w-full" @click="router.push('/profile')"
      >Sign In</AppButton
    >
    <AppButton variant="outline" class="w-full" @click="router.push('/')"
      >Continue as Guest</AppButton
    >

    <p class="text-center text-sm text-muted-foreground">
      Don't have an account?
      <button class="text-primary" @click="router.push('/signup')">
        Create Account
      </button>
    </p>
  </AuthForm>
