...
const arText: Record<string, string> = {
  ...
  "Support · We're online": "الدعم · نحن متصلون",
  "We're here to help. Reach out and our team will get back to you within 24 hours.":
    "نحن هنا لمساعدتك. تواصل معنا وسيرد فريقنا خلال 24 ساعة.",
  "Email us": "راسلنا",
  "Call us": "اتصل بنا",
  "Visit us": "زرنا",
  "Smart Village, Giza": "القرية الذكية، الجيزة",
  ...
  "Thanks for reaching out. Our support team will reply within 24 hours.":
    "شكراً لتواصلك. سيرد فريق الدعم خلال 24 ساعة.",
  "Send another": "إرسال رسالة أخرى",
  "What can we help with?": "بماذا يمكننا مساعدتك؟",
  "General": "عام",
  "Payment": "الدفع",
  "Feedback": "ملاحظات",
  "Your Name": "اسمك",
  ...
  "We typically respond within 24 hours": "نرد عادةً خلال 24 ساعة",
  "Please enter your name": "من فضلك اكتب اسمك",
  "Please enter a valid email": "من فضلك اكتب بريداً إلكترونياً صحيحاً",
  "Please enter a message": "من فضلك اكتب رسالة",
  "Frequently Asked Questions": "الأسئلة الشائعة",
  "How do I book a ticket?": "كيف أحجز تذكرة؟",
  "Search for your route, select your preferred option, and click Book & Pay. You will receive a digital QR ticket valid for 24 hours.":
    "ابحث عن مسارك، واختر الخيار المفضل، ثم اضغط احجز وادفع. ستحصل على تذكرة رقمية بكود QR صالحة لمدة 24 ساعة.",
  ...
  "We accept InstaPay, credit/debit cards, Apple Pay, and cash payment on board for select routes.":
    "نقبل إنستاباي والبطاقات الائتمانية والخصم وآبل باي والدفع النقدي على متن بعض المسارات.",
  "Can I use the app offline?": "هل يمكنني استخدام التطبيق بدون إنترنت؟",
  "Yes. Download routes for offline use from the Saved & History section.":
    "نعم. حمّل المسارات للاستخدام دون إنترنت من قسم المحفوظات والسجل.",
  "What is AI Trip Planner?": "ما هو مخطط الرحلات الذكي؟",
  "AI Trip Planner creates complete day itineraries based on your budget and interests.":
    "ينشئ مخطط الرحلات الذكي برامج يوم كامل بناءً على ميزانيتك واهتماماتك.",
  "Our office": "مكتبنا",
  "Smart Village, Building B12": "القرية الذكية، مبنى B12",
  ...
  "Closed": "مغلق",
  "Follow us": "تابعنا",
  "Stay updated on new routes and features.": "تابع جديد المسارات والمزايا.",
  "Need urgent help?": "تحتاج مساعدة عاجلة؟",
  "Our support team is available 24/7.": "فريق الدعم متاح على مدار الساعة.",
};
