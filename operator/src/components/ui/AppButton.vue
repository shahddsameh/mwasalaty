...
const variants = {
  primary: "bg-primary text-primary-contrast shadow-sm hover:bg-primary-hover hover:text-white active:bg-primary-hover",
...
const buttonClass = computed(
  () =>
    `tap-target inline-flex items-center justify-center rounded-xl font-semibold transition-colors duration-150 focus-ring disabled:cursor-not-allowed disabled:opacity-50 ${variants[props.variant]} ${sizes[props.size]}`
);
</script>
